...
<body class="min-h-full bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 font-['Poppins']">
            ...
            <form id="login-form" class="space-y-6"><!-- Email Input -->
                <div class="input-group"><label for="email" id="email-label" class="input-label">Email
                    ...
                    <div class="relative"><input type="email" id="email" name="email" required
                            class="form-input w-full px-4 py-3 pl-12 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:outline-none text-gray-800 font-medium bg-white"
                ...
                <div class="input-group"><label for="password" id="password-label" class="input-label">Password</label>
                    <div class="relative"><input type="password" id="password" name="password" required
                        ...
                        </div><button type="button" id="toggle-password"
                            class="password-toggle absolute right-4 top-3.5 p-1 rounded-lg text-gray-400 hover:text-green-600">
        ...
        const element = {
            ...
            render: async (config) => {
                ...
                document.getElementById('login-button-text').textContent = config.login_button_text || defaultConfig
                    .login_button_text;
                document.getElementById('forgot-password-link').textContent = config.forgot_password_text ||
                    defaultConfig.forgot_password_text;
                ...
                document.body.style.background =
                    `linear-gradient(135deg, #f1f5f9 0%, ${backgroundColor} 50%, #ecfdf5 100%)`;
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML =
                        "window.__CF$cv$params={r:'992e5fdc7252ec19',t:'MTc2MTE5MjUxOS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
